...
import { Cloud, HelpCircle, History, Zap, Headphones, Check } from "lucide-react";
  ...
  const servicesList = [
    {
      ...
      description: "Real-time dashboards, predictive models, and financial planning embedded into SAP.",
      icon: Cloud,
    },
    {
      title: "Microsoft Power BI",
      description: "Interactive visualizations and cross-platform reporting with secure data connectivity.",
      icon: HelpCircle,
    },
    {
      title: "Enterprise Reporting & Forecasting",
      description: "Streamlined planning cycles, automated financial consolidations, and driver-based budgeting.",
      icon: History,
    },
    {
      title: "KPI Dashboards & Pixel Reports",
      description: "Role-based insights that drive quicker decisions and empower end users.",
      icon: Zap,
    },
  ];
      ...
      <main className="flex-1">
        ...
        <section className="pt-24 pb-16 px-4 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-bold text-[#111827] tracking-tight leading-tight max-w-2xl mx-auto mb-6">
            From Data to Decisions. All in Real-Time.
          </h2>

          {/* Description */}
          <p className="text-gray-500 text-sm sm:text-[15px] leading-relaxed max-w-2xl mx-auto font-normal px-2">
            We empower organizations to move from spreadsheets to insights by delivering data visualization, planning, and forecasting solutions integrated with SAP and Microsoft platforms.
          </p>
        </section>
        ...
        <section className="py-12 px-6 max-w-4xl mx-auto text-center">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-12">
            Our Analytics & Planning Services
          </h3>
          ...
          <div className="w-full flex justify-start mb-20">
            <ul className="space-y-4 text-gray-500 text-[13px] sm:text-[14px] font-medium max-w-2xl">
              <li className="flex items-start gap-3">
                ...
                <span className="mt-[1px]">Strategic Partnerships with Global Vendors</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-slate-100 border border-slate-300 mt-[2px] shrink-0">
                  <Check className="w-3.5 h-3.5 text-slate-500 stroke-[3]" />
                </div>
                <span className="mt-[1px]">Cross-functional expertise in Finance, Sales, and SCM analytics</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-slate-100 border border-slate-300 mt-[2px] shrink-0">
                  <Check className="w-3.5 h-3.5 text-slate-500 stroke-[3]" />
                </div>
                <span className="mt-[1px]">Strong Integration with SAP Core for seamless reporting</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-slate-100 border border-slate-300 mt-[2px] shrink-0">
                  <Check className="w-3.5 h-3.5 text-slate-500 stroke-[3]" />
                </div>
                <span className="mt-[1px]">Focus on insight to action enablement</span>
              </li>
            </ul>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="relative overflow-visible rounded-[14px] bg-gradient-to-r from-[#FFE7D9] via-[#FFF1F3] to-[#E9EAFF] p-10 sm:p-12 text-center shadow-sm border border-white/50">
            <h3 className="text-[26px] sm:text-[30px] font-extrabold text-[#111827] mb-2 tracking-tight">
              Let's Help You Plan Confidently
            </h3>
            <p className="text-gray-600 text-xs sm:text-sm mb-6 font-medium">
              Bring clarity and speed to your decision-making
            </p>
